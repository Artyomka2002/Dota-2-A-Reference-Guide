...
module.exports = function GetValueFromBuffer(arrayBuffer, byteIndex, type, isTypedArray, order) {
	...
	// 8. If isLittleEndian is not present, set isLittleEndian to either true or false. The choice is implementation dependent and should be the alternative that is most efficient for the impl//! moment.js locale configuration
...
export default moment.defineLocale('ar-ma', {
    ...
    monthsShort:
        'يناير_فبراير_مارس_أبريل_ماي_يونيو_يو