    ...
    <>
      <div className={cl.rightInfo}>
        <div style={{ display: "flex", flexDirection: "column", gap: "20px",alignItems:'center'}}>
          ...
          <div className={cl.blockLeftMainInfo}>
            <div className={cl.contSpan}>
              <span>
                <span style={{color:'#008eff'}}>Базовый интелект:</span> {dataSorce.base_int}
              </span>
              <span>
                <span  style={{color:'rgb(0 192 20)'}}>Базовая ловкость:</span> {dataSorce.base_str}
              </span>
            </div>
            <div className={cl.attrOne}>
              <span>
                <span style={{color:'#e30009'}}>Базовая сила:</span> {dataSorce.base_agi}
              </span>
              <span>
                <span>Прирост за уровень:</span> {dataSorce.agi_gain}
              </span>
            </div>
          </div>
          <main className={cl.mainTwo}>
            <h2 className={cl.attrHerosSpan}>Базовые характеристики героя</h2>
            <div className={cl.contBotInfo}>
              <div className={`${cl.containerTopImg} ${cl.conainetLeftTopImg}`}>
                ...
                <div>
                  ...
                  <p>
                    {dataSorce.base_attack_min}/{dataSorce.base_attack_max}
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p>
                    {dataSorce.day_vision}/{dataSorce.night_vision}
                  </p>
                </div>
              ...
              <div className={cl.containerTopImg}>
                ...
                <div>
                  <img src={imgMageResist} alt="MISSING JPG" />
                  <p>{dataSorce.base_mr + "%"}</p>
                </div>
                <label>Скорость атаки</label>
                <div>
                  <img src={imgTimeAttacks} alt="MISSING JPG" />
                  <p>{dataSorce.base_attack_time}</p>
                </div>
                <label>Скорость передвижения</label>
                <div>
                  <img src={imgSpeed} alt="MISSING JPG" />
                  <p>{dataSorce.move_speed}</p>
                </div>
                ...
                <div>
                  ...
                  />
                  <p>
                    {dataSorce.primary_attr === sortAttrIcon.id
                      ? sortAttrIcon.name
                      : "Не нашел"}
                  </p>
                </div>
            ...
            <div className={cl.HeatManaContainer}>
              ...
              <div className={cl.Manapul}>
                ...
                <span>{"+" + dataSorce.base_mana_regen}</span>
              </div>
            </div>
          </main>
        </div>
        <div className={cl.buttonContainer}>
          ...
          <span>{dataSorce.localized_name}</span>
          <button
            className={cl.buttonNavigateBottom}
            onClick={() => {
              const nextId = parseInt(id, 10) + 1;
